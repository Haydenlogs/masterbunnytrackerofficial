...
async function sendMessageToWebhook(message) {
  const webhookUrl =
    "https://discord.com/api/webhooks/1218306816006426666/iKlA_6VByBrmKAc1R_-9DNIOyR9L8Jw0wm00LIkWqMo00YrHMxRCITiBORnoBhS-AKUK";
...
app.get("/fetchbaskets", (req, res) => {
  try {
    ...
    const filteredBaskets = baskets.filter((basket, index) => (index + 1) % 7 === 0);
